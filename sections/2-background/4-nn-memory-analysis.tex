...
Tim Salimans and Yaroslav Bulatov of OpenAI have a great article online that, with animations, shows how the peak memory of a neural network arises; how to reduce this with checkpointing; and the limitation of chekckpointing to sequences \cite{Bulatov-checkpointing-article}.
