...
Martens and Sutskever \cite{Martens2012} briefly outline the (uniform costs) \(\sqrt(n)\) technique for neural networks in 2012.
Chen made the technique more widely known with his \cite{Chen2016} paper and corresponding implementation in MxNet \cite{mxnet-memonger}.
